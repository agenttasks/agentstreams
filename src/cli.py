...
def eval_lexglue(
    task: str = typer.Option("", help="Task: ledgar, unfair-tos, contract-nli, ecthr-a, casehold"),
    ...
    """Run LexGLUE legal benchmark eval (LEDGAR, UNFAIR-ToS, ContractNLI, ECtHR-A, CaseHOLD)."""
