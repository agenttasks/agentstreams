...
AGENT_DESCRIPTIONS: dict[str, str] = {
    ...
    "marketing-agent": "Marketing agent for content creation, campaign planning, brand strategy, SEO optimization, and competitive briefs. Handles skills from the marketing plugin of anthropics/knowledge-work-plugins. Connectors to Canva, Figma, HubSpot, Amplitude, Ahrefs, Klaviyo.",
