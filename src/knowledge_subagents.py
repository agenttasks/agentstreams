...
AGENT_DESCRIPTIONS: dict[str, str] = {
    ...
    "data-analyst": "Data querying, visualization, and analysis agent. Handles skills from the data plugin of anthropics/knowledge-work-plugins — SQL queries, statistical analysis, dashboards, and data validation. Connectors to BigQuery, Definite, Hex, Amplitude, Amplitude EU, Atlassian.",
    ...
    "engineering-agent": "Engineering workflow agent for architecture design, code improvement, debugging, deployment verification, incident response, and technical documentation. Handles skills from the engineering plugin of anthropics/knowledge-work-plugins.",
    ...
    "finance-agent": "Financial operations agent for journal entries, reconciliation, financial statements, variance analysis, close management, and audit support. Handles skills from the finance plugin of anthropics/knowledge-work-plugins. Connectors to BigQuery, Gmail, Google Calendar, Microsoft 365, Slack.",
    ...
    "compliance-reviewer": "Legal and compliance agent for contract review, NDA triage, risk assessment, and regulatory compliance. Handles skills from the legal plugin of anthropics/knowledge-work-plugins. Connectors to Slack, Box, Egnyte, DocuSign, Atlassian, Gmail, Google Calendar, Microsoft 365.",
    "marketing-agent": "Marketing agent for content creation, campaign planning, brand strategy, SEO optimization, and competitive briefs. Handles skills from the marketing plugin of anthropics/knowledge-work-plugins. Connectors to Canva, Figma, HubSpot, Amplitude, Ahrefs, Klaviyo, Gmail, Google Calendar, Notion, SimilarWeb, Slack.",
    ...
    "productivity-agent": "Productivity agent for task management, calendar workflows, daily context, and memory management. Handles skills from the productivity plugin of anthropics/knowledge-work-plugins. Connectors to Slack, Notion, Asana, Linear, Atlassian, Monday, ClickUp, Microsoft 365, Gmail, Google Calendar.",
    "sales-agent": "Sales intelligence agent for prospect research, call prep, pipeline review, outreach drafting, and competitive battlecards. Handles skills from the sales plugin of anthropics/knowledge-work-plugins. Connectors to Slack, HubSpot, Close, Clay, ZoomInfo, Fireflies, Apollo, Atlassian, Gmail, Google Calendar, Microsoft 365, Notion, Outreach, SimilarWeb.",
}
