...
OPUS_GOVERNANCE = GovernanceProfile(
    ...
    assessments=[
        ThreatAssessment(ThreatModel.AUTONOMY_1, applicable=True, safety_level=SafetyLevel.ASL_3,
                         mitigations=["24hr alignment-focused testing window"]),
        ThreatAssessment(ThreatModel.CB_1, applicable=True, safety_level=SafetyLevel.ASL_3,
...
MYTHOS_GOVERNANCE = GovernanceProfile(
    ...
    assessments=[
        ...
        ThreatAssessment(ThreatModel.AUTONOMY_2, applicable=False,
        ...
        ThreatAssessment(ThreatModel.CYBER, applicable=True, safety_level=SafetyLevel.ASL_3,
                         mitigations=["Project Glasswing — defensive use only"]),
    ],
    partners=[
        "AWS", "Microsoft", "Google", "NVIDIA", "Linux Foundation",
        "CrowdStrike", "Palo Alto Networks", "Apple",
    ],
    restrictions=[
