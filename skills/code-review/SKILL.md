...
- Model: claude-opus-4-6 for security-auditor, alignment-auditor, architecture-reviewer; claude-sonnet-4-6 for code-generator, test-runner, prompt-hardener, eval-builder; claude-haiku-4-5 for harmlessness-screen
